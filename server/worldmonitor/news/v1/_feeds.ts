...
// Optional escape hatch for regions where Google News RSS is unstable/blocked.
// Example:
//   RSS_APNEWS_FALLBACK_URL=https://rsshub.app/apnews
const APNEWS_FALLBACK_URL = process.env.RSS_APNEWS_FALLBACK_URL?.trim();
const apNewsFeed = () => APNEWS_FALLBACK_URL || gn('site:apnews.com');
